...
import static portfolioTracker.util.TransactionTestUtil.extractMessagesFromViolationSetCreateRequest;
import static portfolioTracker.util.TransactionTestUtil.extractMessagesFromViolationSetEntity;

@SpringBootTest
class TransactionDtoCreateRequestTest {

    private final TransactionDtoCreateRequest requestDto = new TransactionDtoCreateRequest();
